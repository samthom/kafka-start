package com.github.samthom.kafka.first;
...
public class ConsumerGroupsThreads {
    ...
    private ConsumerGroupsThreads() {

    }

    private void run() {
        Logger logger = LoggerFactory.getLogger(ConsumerGroupsThreads.class.getName());
    ...
    public class ConsumerThread implements Runnable {
        ...
        public void shutdown() {
            // The wake up method is a special method to interrupt consumer.poll()
